...
if($this->connection == null)
    $tableWithPrefix = 'laravel_'.$table;
        $rawFoo = $connect->getDoctrineSchemaManager()->listTableColumns($tableWithPrefix);
        $foo = [];
...
//dd($connect->getDoctrineSchemaManager()->listTableColumns($table));
